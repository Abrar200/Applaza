      ...
      <div className="bg-gray-900 rounded-xl border border-gray-800 max-w-md w-full">
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div className="flex gap-3 pt-4">
            <button type="button" onClick={onClose} className="flex-1 bg-gray-800 hover:bg-gray-700 text-white px-6 py-3 rounded-lg font-semibold">
              Cancel
            </button>
            <button type="submit" className="flex-1 bg-cyan-500 hover:bg-cyan-600 text-white px-6 py-3 rounded-lg font-semibold">
              Add User
            </button>
          </div>
        </form>
